...
Keywords: \lit{alias}, \lit{attributes}, \lit{include}, \lit{import}, \lit{module}, \lit{primitive}, \lit{view}
...
In its basic form, a view entry consists of a \synt<view-entity>, which specifies a module,
